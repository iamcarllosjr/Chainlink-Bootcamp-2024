...
contract TokenShop {
    ...
    uint256 public tokenPrice = 2000000000000000000; //1 token = 2.00 usd, with 18 decimal places
    ...
    */
    ...
    function tokenAmount(uint256 amountETH) public view returns (uint256) {
        ...
        uint256 amountToken = amountUSD * (10**(18 - 8)) / tokenPrice;  //8 decimal places from ETHUSD / 18 decimal places from token 
        return amountToken;
    } 
